...
export const logbookPosts: LogbookPost[] = [
  {
    id: "1",
  ...
  {
    id: "2",
    slug: "the-poetry-of-code-finding-beauty-in-logic",
  ...
  {
    id: "3",
    slug: "contemplations-on-trust-in-modern-society",
    title: "Contemplations on Trust in Modern Society",
    date: "2024-01-10",
    cover: "/placeholder.svg",
    excerpt:
      "Trust forms the invisible foundation upon which all human relationships are built...",
    tags: ["philosophy", "society", "trust"],
  },
  {
    id: "4",
    slug: "walking-through-ideas-a-philosophical-journey",
    title: "Walking Through Ideas: A Philosophical Journey",
    date: "2024-01-08",
    cover: "/placeholder.svg",
    excerpt:
      "Sometimes the best thoughts come not when we sit to think, but when we walk to discover...",
    tags: ["philosophy", "walking", "thoughts"],
  },
  {
    id: "5",
    slug: "when-silence-speaks-louder",
    title: "When Silence Speaks Louder",
    date: "2024-01-06",
    cover: "/placeholder.svg",
    excerpt:
      "In a world overwhelmed by noise, silence becomes a radical act of presence...",
    tags: ["reflection", "silence", "culture"],
  },
  {
    id: "6",
    ...
    cover: "/placeholder.svg",
    excerpt:
      "Design is not just how it looks, but how it makes someone feel — an invisible language of empathy...",
    tags: ["design", "emotion", "user-experience"],
  },
  {
    id: "7",
    slug: "notes-on-fragile-systems",
    title: "Notes on Fragile Systems",
    date: "2024-01-02",
    cover: "/placeholder.svg",
    excerpt:
      "Whether biological, digital, or social — fragility reveals itself in how systems respond to failure...",
    tags: ["systems", "resilience", "technology"],
  },
  {
    id: "8",
    slug: "memory-as-a-medium",
    title: "Memory as a Medium",
    date: "2023-12-30",
    cover: "/placeholder.svg",
    excerpt:
      "Every act of remembering reshapes the past — memory is not storage, it's authorship...",
    tags: ["memory", "philosophy", "self"],
  },
  {
    id: "9",
    slug: "the-weight-of-unfinished-thoughts",
    title: "The Weight of Unfinished Thoughts",
    date: "2023-12-28",
    cover: "/placeholder.svg",
    excerpt:
      "Sometimes the ideas we abandon shape us more than the ones we complete...",
    tags: ["thoughts", "creativity", "reflection"],
  },
  {
    id: "10",
    slug: "artifacts-of-introspection",
    title: "Artifacts of Introspection",
    date: "2023-12-26",
    cover: "/placeholder.svg",
    excerpt:
      "What remains after deep reflection isn’t always clarity — it’s often the shape of what we felt...",
    tags: ["introspection", "journal", "self-awareness"],
  },
  {
    id: "11",
    slug: "the-beauty-of-departure",
    title: "The Beauty of Departure",
    date: "2023-12-24",
    cover: "/placeholder.svg",
    excerpt:
      "Leaving something — a place, a person, a version of yourself — is sometimes the most creative act...",
    tags: ["change", "philosophy", "life"],
  },
  {
    id: "12",
    slug: "beneath-the-api",
    title: "Beneath the API",
    date: "2023-12-22",
    cover: "/placeholder.svg",
    excerpt:
      "Behind every endpoint is a contract of trust, a language of intention, and a philosophy of interaction...",
    tags: ["tech", "api", "design"],
  },
  {
    id: "13",
    slug: "why-some-ideas-never-leave",
    title: "Why Some Ideas Never Leave",
    date: "2023-12-20",
    cover: "/placeholder.svg",
    excerpt:
      "Certain thoughts return not because they’re important, but because they’re unresolved...",
    tags: ["ideas", "mind", "loops"],
  },
  {
    id: "14",
    slug: "interfaces-and-inwardness",
    title: "Interfaces and Inwardness",
    date: "2023-12-18",
    cover: "/placeholder.svg",
    excerpt:
      "We design outward-facing tools for inward-facing journeys — where UI meets human meaning...",
    tags: ["interface", "introspection", "philosophy"],
  },
];
